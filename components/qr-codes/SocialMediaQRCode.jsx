...
export default function SocialMediaQRCode() {
  ...
  useEffect(() => {
    if (qrCode.current) {
      const data =
        headline || facebook || instagram || twitter || linkedin
          ? `Headline:${headline},Facebook:${facebook},Instagram:${instagram},Twitter:${twitter},Linkedin:${linkedin}`
          : "";
  ...
  return (
    <div className="flex flex-col md:flex-row md:justify-between w-full space-y-5 md:space-y-0 md:space-x-5 items-start">
      <div className="w-full md:w-1/2 max-w-lg">
        <h1 className="text-2xl mb-2">Basic Information</h1>
